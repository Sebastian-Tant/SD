...
jest.mock("../components/UsageChart", () => () => (
  <section data-testid="usage-chart">Usage Chart</section>
));

jest.mock("../components/MaintenanceChart", () => () => (
  <section data-testid="maintenance-chart">Maintenance Chart</section>
));

jest.mock("../components/PeakHoursChart", () => () => (
  <section data-testid="peak-hours-chart">Peak Hours Chart</section>
));
  ...
  const mockSubfacilities = [
    {
      id: "sub1",
      data: () => ({
        bookings: [{ bookedAt: new Date().toISOString() }],
      }),
    },
  ];
