...
import { FaBell, FaSignOutAlt } from "react-icons/fa"; // Added FaSignOutAlt
...
const Navbar = () => {
  ...
  useEffect(() => {
    const handleClickOutside = (event) => {
      ...
      const mobileNotificationTrigger = document.querySelector(".mobile-notification-trigger");
  ...
  useEffect(() => {
    if (user) {
      ...
      const unsubscribeNotifs = onSnapshot(doc(db, "users", user.uid), (doc) => {
  ...
  const handleGoogleSignIn = async () => {
    try {
      ...
      // navigate to a default page or reload if needed after sign-in
    } catch (error) {
  ...
  const closeMobileMenu = () => {
    ...
    setMobileNotificationsOpen(false); // Close notifications when main menu closes
  };
        ...
        <section className="navbar-content">
          ...
          <menu className="desktop-nav">
            ...
            <li className="dropdown">
              <div className="button-nav-link dropdown-toggle">Bookings</div>
              <ul className="dropdown-menu">
                <li><Link to="/bookings" className="dropdown-item">Make a booking</Link></li>
                <li><Link to="/my-bookings" className="dropdown-item">My bookings</Link></li>
              </ul>
            </li>
            ...
            <li className="dropdown">
              <div className="button-nav-link dropdown-toggle">Applications</div>
              <ul className="dropdown-menu">
                <li><Link to="/applications" className="dropdown-item">Apply</Link></li>
                <li><Link to="/application-status" className="dropdown-item">View applications</Link></li>
              </ul>
            </li>
            {user?.role === "Admin" && (
              ...
              <section className="user-section">
                <figure className="user-avatar">
                  {user.photoURL ? (
                    ...
                    <i className="fas fa-user"></i> // Consider using FaUserCircle from react-icons
                  )}
                </figure>
                ...
                <button onClick={handleSignOut} className="fancy-sign-out-button">
                  <FaSignOutAlt className="fancy-sign-out-icon" />
                  <span className="fancy-sign-out-text">Sign Out</span>
                </button>
              </section>
            ) : (
            ...
            <li className="mobile-auth-item">
              {user ? (
                <div className="mobile-user-section">
                  ...
                  <button onClick={() => { handleSignOut(); closeMobileMenu(); }} className="mobile-fancy-sign-out-button">
                    <FaSignOutAlt className="fancy-sign-out-icon" />
                    <span className="fancy-sign-out-text">Sign Out</span>
                  </button>
                </div>
              ) : (
                 // Mobile Google Sign In button - keeps mobile-auth-btn class
