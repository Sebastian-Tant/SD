        ...
        for (const facility of facilitiesToProcess) {
          if (facility.has_subfacilities) {
            const subfacilitiesRef = collection(
              db,
              `facilities/${facility.id}/subfacilities`
            );
  ...
  return (
    ...
    >
      <section className="chart-header">
        ...
        <section className="dropdown-container" ref={dropdownRef}>
          <motion.button
      ...
      <section className="cards-parent-container">
        <motion.section
          className="parent"
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
          ...
          <section className="flip-card">
            <section className="flip-card-inner">
              <section className="flip-card-front">
                ...
                <FontAwesomeIcon
                  icon={faChartLine}
                  className="flip-card-icon text-indigo-400"
                />
          ...
          <section className="flip-card">
            <section className="flip-card-inner">
              <section className="flip-card-front">
                ...
                <FontAwesomeIcon
                  icon={faClock}
                  className="flip-card-icon text-blue-400"
                />
                <p className="flip-card-hint">Hover to see details</p>
              </section>
              <section className="flip-card-back">
          ...
          <section className="flip-card">
            <section className="flip-card-inner">
              <section className="flip-card-front">
                ...
                <FontAwesomeIcon
                  icon={faLightbulb}
                  className="flip-card-icon text-amber-400"
                />
                <p className="flip-card-hint">Hover to see details</p>
              </section>
              <section className="flip-card-back">
